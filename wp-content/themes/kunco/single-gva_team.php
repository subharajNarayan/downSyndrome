        ...
        <?php while ( have_posts() ) : the_post(); ?>
          ...
          <div class="team-block-single clearfix single">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              ...
              <?php if( is_array($team_educations) && isset($team_educations[0]) && !empty($team_educations[0])){ ?>
                <div class="team-educations">
                  <div class="heading"><?php echo esc_html__('Education', 'kunco') ?></div>
