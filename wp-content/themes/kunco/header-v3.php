...
<body <?php body_class() ?>>
  <div class="wrapper-page header-absolute"> <!--page-->
   <?php do_action( 'kunco_before_header' );  ?>
    <?php 
      $classes_header = '';
      $classes_header = kunco_get_option('header_search', 'enable') == 'disable' ? 'disable-search' : '';
      if(kunco_get_option('header_cart', 'enable') == 'disable'){
        $classes_header = empty($classes_header) ? 'disable-cart' : 'disable-cart-search';
      }
    ?>
    <header class="header-default header-v3 <?php echo esc_attr($classes_header) ?>">
            ...
            <div class="prelative">
              <div class="row">
                ...
                <div class="col-lg-10 col-md-10 pstatic">
                  ...
                  <?php if(kunco_get_option('header_search', 'enable') == 'enable'){ ?>
                  ...
                  <?php if(kunco_get_option('header_cart', 'enable') == 'enable'){ ?>
