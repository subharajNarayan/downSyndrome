...
require_once(KUNCO_THEMER_DIR . '/includes/customize/custom-color.php'); 
require_once(KUNCO_THEMER_DIR . '/includes/customize/custom-typo.php'); 
...
function kunco_init_scripts(){
  ...
  wp_enqueue_script('kunco-main', get_template_directory_uri() . '/js/main.js', array('jquery', 'imagesloaded', 'masonry'));
  ...
  if(kunco_woocommerce_activated() ){
    ...
    wp_enqueue_script('kunco-woocommerce', get_template_directory_uri() . '/js/woocommerce.js' );
  }
  ...
  wp_enqueue_style('kunco-bootstrap', get_template_directory_uri(). '/css/' . $skin . 'bootstrap.css', array(), $theme_version , 'all'); 
  wp_enqueue_style('kunco-woocoomerce', get_template_directory_uri(). '/css/' . $skin . 'woocommerce.css', array(), $theme_version , 'all'); 
  wp_enqueue_style('kunco-template', get_template_directory_uri().'/css/' . $skin . 'template.css', array(), $theme_version , 'all');
}
