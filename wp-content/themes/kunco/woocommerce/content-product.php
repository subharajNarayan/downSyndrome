...
<div <?php post_class( $classes ); ?>>
	<div class="product-block-inner clearfix">
        ...
        <div class="shop-loop-actions ">	
          ...
          <div class="quickview">
            <a href="javascript:void(0);" data-product_id="<?php echo esc_attr( $product->get_id() ) ?>" class="btn-quickview product_type_<?php echo esc_attr( $product->get_type() ) ?>" title="<?php echo esc_attr__('Quick View', 'kunco') ?>"><span class="gv-icon-41"></span></a>
		      </div>
        </div>
