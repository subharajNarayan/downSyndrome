  ...
  */
    ...
    'fields' => array(
      ...
      array(
          'id'        => 'color_theme',
          'type'         => 'color',
          'title'        => esc_html__( 'Custom Color Theme', 'kunco' ),
          'desc'         => esc_html__( 'Used custom color theme instead of Skin Colors Available.', 'kunco' ),
          'default'      => '',
          'transparent'  => false,
          'validate'     => 'color'
      ),
      array(
          ...
          'type'         => 'color',
          'title'        => esc_html__( 'Custom Color Theme Second', 'kunco' ),
          'desc'         => esc_html__( 'Used custom color theme second instead of Skin Colors Available.', 'kunco' ),
          'default'      => '',
          'transparent'  => false,
          'validate'     => 'color'
      ),
   ...
   //Header
    ...
    'fields' => array(
      array(
        ...
        'subtitle' => esc_html__('Select a header layout option, empty = header default', 'kunco'),
        'options' => array(
          ''   => 'Default',
          'v2' => 'Header v2',
          'v3' => 'Header v3',
      ...
      array(
        'id' => 'header_search',
        'type' => 'button_set',
        'title' => esc_html__('Header Search', 'kunco'),
        'desc' => '',
      ...
      array(
        'id' => 'header_cart',
        'type' => 'button_set',
        'title' => esc_html__('Header Icon Cart', 'kunco'),
        'desc' => '',
        'options' => array('disable' => 'Disable', 'enable' => 'Enable'),
        'default' => 'enable'
      ),
  ...
  Redux::setSection( $opt_name, array(
	...
	Redux::setSection( $opt_name, array(
      ...
      array(
        'id'    => 'social_flickr',
        'type'    => 'text',
        'title'   => esc_html__( 'Flickr', 'kunco' ),
        'desc'    => esc_html__( 'Enter your Flickr profile URL.', 'kunco' ),
        'default' => ''
      ),
      array(
        'id'    => 'social_vk',
        'type'    => 'text',
        'title'   => esc_html__( 'VK', 'kunco' ),
        'desc'    => esc_html__( 'Enter your VK profile URL.', 'kunco' ),
        'default' => ''
      )
		)
	) );
