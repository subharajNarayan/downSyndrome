...
class kunco_Visualcomposer_Theme implements Vc_Vendor_Interface {
    ...
    $gva_brands = array(
      ...
      'params'    => array(
        ...
        array(
          'type'        => 'textfield',
          'heading'     => esc_html__( 'Brand IDs', 'kunco' ),
          'param_name'  => 'brand_ids',
          'description'    => esc_html__('You can add ids. E.g 1,2,3,4', 'kunco'),
          'value'       => ''
        ),
        array(
          'type'         => 'dropdown',
    ...
    $el_team_carousel = array(
      ...
      'params' => array(
        ...
        array(
          'type'        => 'textfield',
          'heading'     => esc_html__( 'Team IDs', 'kunco' ),
          'param_name'  => 'team_ids',
          'description'    => esc_html__('You can add ids. E.g 1,2,3,4', 'kunco'),
          'value'       => ''
        ),
    ...
    //=== Image Content ===
    vc_map( array(
      'name'      => esc_html__( 'GVA Image with Content', 'kunco' ),
