 ...
 */
    ...
    $default_sidebar_config = kunco_get_option('single_service_sidebar', 'right-sidebar'); 
    $default_left_sidebar = kunco_get_option('single_service_left_sidebar', 'blog_sidebar');
    $default_right_sidebar = kunco_get_option('single_service_right_sidebar', 'blog_sidebar');
